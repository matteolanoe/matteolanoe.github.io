...
<i class="bi bi-file-earmark-pdf"></i> [Syllabus du cours](docs/images/syllabus.pdf){download="syllabus.pdf"}
...
<i class="bi bi-file-earmark-pdf"></i> [Télécharger les slides (PDF)](docs/images/methodes_quanti_1.pdf){download="methodes_quanti_1.pdf"} <br>
<i class="bi bi-file-earmark-spreadsheet"></i> [Télécharger le jeu de données Titanic (titanic.csv)](docs/images/titanic.csv){download="titanic.csv"}
:::
...
<i class="bi bi-file-earmark-pdf"></i> [Télécharger les slides (PDF)](docs/images/methodes_quanti_2.pdf){download="methodes_quanti_2.pdf"} <br>
<i class="bi bi-file-earmark-code"></i> [Télécharger le script R de la séance 2](docs/images/script_seance_2.R){download="script_seance_2.R"}
:::
...
<i class="bi bi-file-earmark-pdf"></i> [Télécharger les slides (PDF)](docs/images/methodes_quanti_3.pdf){download="methodes_quanti_3.pdf"} <br>
<i class="bi bi-file-earmark-code"></i> [Télécharger le script R de la séance 3](docs/images/script_seance_3.R){download="script_seance_3.R"}
:::
...
<i class="bi bi-file-earmark-pdf"></i> [Télécharger les slides (séance 4, PDF)](docs/images/methodes_quanti_4-1.pdf){download="methodes_quanti_4-1.pdf"} <br>
<i class="bi bi-file-earmark-pdf"></i> [Télécharger les slides (séance 5, PDF)](docs/images/methodes_quanti_4-2.pdf){download="methodes_quanti_4-2.pdf"} <br>
<i class="bi bi-file-earmark-code"></i> [Télécharger le script R de la séance 4](docs/images/script_seance_4.R){download="script_seance_4.R"} <br>
<i class="bi bi-file-earmark-code"></i> [Télécharger le script R de l'exercice en séance 5](docs/images/exercice_seance5.R){download="exercice_seance5.R"} <br>
<br>
*Télécharger les jeux de données à utiliser pendant le cours :* <br>

<i class="bi bi-file-earmark-spreadsheet"></i> [Télécharger le jeu de données avant la loterie](docs/images/expe_lycee_Ghana_avantloterie.csv){download="expe_lycee_Ghana_avantloterie.csv"} <br>
<i class="bi bi-file-earmark-spreadsheet"></i> [Télécharger le jeu de données après la loterie](docs/images/expe_lycee_Ghana_aprestloterie.csv){download="expe_lycee_Ghana_aprestloterie.csv"} <br>
<i class="bi bi-file-earmark-spreadsheet"></i> [Télécharger le jeu de données pour les MES](docs/images/expe_lycee_Ghana_MES.csv){download="expe_lycee_Ghana_MES.csv"}
...
<i class="bi bi-file-earmark-pdf"></i> [Télécharger les slides (séance 6, PDF), pas encore disponibles](docs/images/methodes_quanti_6.pdf){download="methodes_quanti_6.pdf"} <br>
<i class="bi bi-book"></i> [Lecture obligatoire : A. Desrosières, *La portée sociologique des diverses phases du travail statistique*](docs/images/desrosieres_portee_socio.pdf){download="desrosieres_portee_socio.pdf"} <br>
